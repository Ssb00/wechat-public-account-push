export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx7ba8c08202b8c4bc",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c95fb0ab730a637d83b388ba7a92d6d0",
  ...
  USERS: [
    {
      ...
      id: "oQt_d6r-DOBosEGZcZAUVztCTw7Q",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "0khihzESNKxOQQCDt5Nw5mH9TJ3VUweUSqP_0Erh-b4",
      // 所在省份
      province: "辽宁",
      // 所在城市
      city: "辽阳",
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2021-06-13"},
        // 考研日
